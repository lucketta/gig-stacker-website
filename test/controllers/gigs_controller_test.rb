...
class GigsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post gigs_url, params: { gig: { industry: @gig.industry, name: @gig.name, photo_url: @gig.photo_url, url: @gig.url } }
    end
  ...
  test "should update gig" do
    patch gig_url(@gig), params: { gig: { industry: @gig.industry, name: @gig.name, photo_url: @gig.photo_url, url: @gig.url } }
